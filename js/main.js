...
(function($) {
    var audio = new Audio('https://raw.githubusercontent.com/huynhloi0910/wedding-loi-quyen/master/music/Mai-Mai-Ben-Nhau-Noo-Phuoc-Thinh.mp3');
    var isFirst = true;
...
/*================================
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2023/06/06', function(event) {
